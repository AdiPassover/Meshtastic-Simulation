...
public final class LogicConstants {
    ...
    // Physics constants
    public static final double EDGE_PROBABILITY_THRESHOLD = 0.1;
    // TODO: should this be very low or very high? (CA: with 0.9 the generated networks aren't nearly connected and success rates are extremely low)
